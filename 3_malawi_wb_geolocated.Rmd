...
##Cleaned in script: 1_aiddata_world_bank_geo.RMD. Filter for Malawi
m <- read_csv("~/Desktop/Semester 6/Thesis/world_bank_projects/world_bank_geo_projects/data/combined_wb_geo.csv") %>%
